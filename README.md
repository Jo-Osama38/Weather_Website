...
هذا المشروع  قمت ببنائه  لاستكمال تعلم فلاسك وأساسيات APIs
## عن المشروع
هو مشروع ويب لمعرفه الطقس في أي دوله في العالم
##ماذا عملت فيه 

اشيااااء كتيره  منها اني اعمل الباك اند
وهذا كان تطوير لي عن المشروع الأول
عملت استخراج لبيانات الاتيه من API  واستخدمت Jinja في html لعرضها
CSS اكتر شي ابدعت فيه وأخذ وقت
عملت  شكل جذاب وحديث ومبتكر وجديد لعرض البيانات في الصفحه
وكمان عملت خلفيات ديناميكية  للصفحه علي حسب حاله الطقس
وكمان اكتر حاجه مبسوط بيها تعلمت الانيميشن  وعملت ايقونه تتحرك وعرض البيانات بطريقه انميشن وغيرها

ماذا تعلمت جديد ##
تطورت جدا بكتابه فلاسك
Jinja في html
تعلمت اساسيات التعامل مع APIs
تعلمت أيضا اشياء جديده في تنسيق ب CSS الصفحه مثل  position  وغيرها
ولا ننسى animation طبعا

كيفيه التشغيل
افتح اللينك وجرب بنفسك
 https://youssefosama.pythonanywhere.com/
